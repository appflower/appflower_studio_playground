<div class="sf_admin_pagination">
  <a href="<?php echo url_for('@sf_guard_user') ?>?page=1">
  ...
  <a href="<?php echo url_for('@sf_guard_user') ?>?page=<?php echo $pager->getPreviousPage() ?>">
  ...
  <a href="<?php echo url_for('@sf_guard_user') ?>?page=<?php echo $pager->getNextPage() ?>">
  ...
  <a href="<?php echo url_for('@sf_guard_user') ?>?page=<?php echo $pager->getLastPage() ?>">
