...
abstract class BaseResourceAttributeVersionHashPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('RESOURCE_ATTRIBUTE_VERSION_ID', 'RESOURCE_VERSION_ID', 'IS_MODIFIED', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('RESOURCE_ATTRIBUTE_VERSION_ID' => 0, 'RESOURCE_VERSION_ID' => 1, 'IS_MODIFIED' => 2, ),
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn($alias . '.RESOURCE_ATTRIBUTE_VERSION_ID');
			$criteria->addSelectColumn($alias . '.RESOURCE_VERSION_ID');
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseResourceAttributeVersionHashPeer', $criteria, $con);
		}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to resource_attribute_version_hash
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ResourceAttributeVersionHashPeer::getOMClass(false);
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (ResourceAttributeVersionHash object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = ResourceAttributeVersionHashPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = ResourceAttributeVersionHashPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + ResourceAttributeVersionHashPeer::NUM_COLUMNS;
		} else {
			$cls = ResourceAttributeVersionHashPeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doCountJoinResourceAttributeVersion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ResourceAttributeVersionHashPeer::RESOURCE_ATTRIBUTE_VERSION_ID, ResourceAttributeVersionPeer::ID, $join_behavior);
	...
	public static function doCountJoinResourceVersion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ResourceAttributeVersionHashPeer::RESOURCE_VERSION_ID, ResourceVersionPeer::ID, $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinResourceAttributeVersion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				if (!$obj2) {
					...
					$cls = ResourceAttributeVersionPeer::getOMClass(false);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinResourceVersion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				if (!$obj2) {
					...
					$cls = ResourceVersionPeer::getOMClass(false);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptResourceAttributeVersion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptResourceVersion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseResourceAttributeVersionHashPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseResourceAttributeVersionHashPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new ResourceAttributeVersionHashTableMap());
	  }
	}
	...
	{
		return $withPrefix ? ResourceAttributeVersionHashPeer::CLASS_DEFAULT : ResourceAttributeVersionHashPeer::OM_CLASS;
	}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(ResourceAttributeVersionHashPeer::RESOURCE_ATTRIBUTE_VERSION_ID);
			if ($value) {
				$selectCriteria->add(ResourceAttributeVersionHashPeer::RESOURCE_ATTRIBUTE_VERSION_ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ResourceAttributeVersionHashPeer::TABLE_NAME);
			}

			$comparison = $criteria->getComparison(ResourceAttributeVersionHashPeer::RESOURCE_VERSION_ID);
			$value = $criteria->remove(ResourceAttributeVersionHashPeer::RESOURCE_VERSION_ID);
			if ($value) {
				$selectCriteria->add(ResourceAttributeVersionHashPeer::RESOURCE_VERSION_ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ResourceAttributeVersionHashPeer::TABLE_NAME);
			}
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ResourceAttributeVersionHashPeer::TABLE_NAME, $con, ResourceAttributeVersionHashPeer::DATABASE_NAME);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			ResourceAttributeVersionHashPeer::clearInstancePool();
			ResourceAttributeVersionHashPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof ResourceAttributeVersionHash) { // it's a model object
	...
	public static function doValidate(ResourceAttributeVersionHash $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(ResourceAttributeVersionHashPeer::DATABASE_NAME, ResourceAttributeVersionHashPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($resource_attribute_version_id, $resource_version_id, PropelPDO $con = null) {
		$_instancePoolKey = serialize(array((string) $resource_attribute_version_id, (string) $resource_version_id));
 		if (null !== ($obj = ResourceAttributeVersionHashPeer::getInstanceFromPool($_instancePoolKey))) {
 			return $obj;
		}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseResourceAttributeVersionHashPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
...
//
BaseResourceAttributeVersionHashPeer::buildTableMap();
